...
-- Ergaenzung zur CLI-Generierung: neuere better-auth-Versionen erwarten
-- account.issuer (OAuth-Issuer). Bei Fresh-Deploys mitenthalten.
alter table "account" add column if not exists "issuer" text;

-- Deny-by-default auch fuer Auth-Tabellen (Zugriff laeuft ueber die
-- postgres-Rolle des DATABASE_URL-Pools, die RLS bypassed).
